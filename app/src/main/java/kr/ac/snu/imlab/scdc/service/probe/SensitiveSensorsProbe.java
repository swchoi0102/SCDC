...
@Schedule.DefaultSchedule(interval= SensitiveSensorsProbe.DEFAULT_PERIOD, duration= SensitiveSensorsProbe.DEFAULT_DURATION)
public class SensitiveSensorsProbe extends Base implements ContinuousProbe, SensorKeys {
	...
	private final String[] GYRO_VALUE_NAMES = new String[]{SCDCKeys.SensitiveSensorsKeys.GYRO_X, SCDCKeys.SensitiveSensorsKeys.GYRO_Y, SCDCKeys.SensitiveSensorsKeys.GYRO_Z};
	...
	private final String[] ROT_VALUE_NAMES = new String[]{SCDCKeys.SensitiveSensorsKeys.ROTATION_COS, SCDCKeys.SensitiveSensorsKeys.ROTATION_X_SIN, SCDCKeys.SensitiveSensorsKeys.ROTATION_Y_SIN, SCDCKeys.SensitiveSensorsKeys.ROTATION_Z_SIN};
	...
	protected void onEnable() {
		...
		accSensor = sensorManager.getDefaultSensor(Sensor.TYPE_GYROEROMETER);
		...
		sensorListener = new SensorEventListener() {
			...
			long lastAccTimeMillis = 0;
			long lastGrvtTimeMillis = 0;
			long lastGyroTimeMillis = 0;
			long lastRotTimeMillis = 0;
			long lastMagTimeMillis = 0;
			long lastOrtTimeMillis = 0;
			long lastLinTimeMillis = 0;
			...
			public void onSensorChanged(SensorEvent event) {
				...
				if (sensorType == Sensor.TYPE_GYROEROMETER &&
						((lastAccTimeMillis > currentTimeMillis + 0.005)
